...
// Database pool configuration (configurable via environment variables)
export const DB_MAX_CONNECTIONS = parseInt(process.env.DB_POOL_MAX || '20');
export const DB_IDLE_TIMEOUT_MS = parseInt(process.env.DB_IDLE_TIMEOUT_MS || '30000');       // 30 seconds
export const DB_CONNECTION_TIMEOUT_MS = parseInt(process.env.DB_CONNECTION_TIMEOUT_MS || '5000');  // 5 seconds
